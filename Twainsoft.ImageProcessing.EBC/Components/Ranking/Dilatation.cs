...
{
    public class Dilatation : EBCBase, IDilatation
    {
        public Dilatation()
        {
        ...
        public override void MessageReceived(IEBCMessage ebcMessage)
        {
            ...
            Bitmap resultingImage = RankingOperations.ImageDilatation(ebcMessage.EBCMessageData.Image, matrix);

            IEBCMessageData ebcMessageData = new EBCMessageData(DataResultTypes.Dilatation,

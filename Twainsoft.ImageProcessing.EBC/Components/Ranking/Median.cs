...
{
    public class Median : EBCBase, IMedian
    {
        public Median()
        {
            this.Name = "Median";
        ...
        public override void MessageReceived(IEBCMessage ebcMessage)
        {
            ...
            Bitmap resultingImage = RankingOperations.ImageMedian(ebcMessage.EBCMessageData.Image, matrix);

            IEBCMessageData ebcMessageData = new EBCMessageData(DataResultTypes.Median,

...
using Twainsoft.ImageProcessing.EBC.Contracts.FloodFilling;
...
using Twainsoft.ImageProcessing.IPLab.FloodFill;
...
namespace Twainsoft.ImageProcessing.EBC.Components.FloodFilling
{
    public class FloodFill : EBCBase, IFloodFill
    {
        public FloodFill()
        {
